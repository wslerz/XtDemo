...
public final class XtSdkInterfaceImpl implements XtSdkInterface {
    ...
    private String mqttServer = "iot.dtznjg.com";
    private String mqttServerPort = "2883";
    private String sipServer = "121.204.184.32";
    private String sipServerPort = "15060";
    ...
    public void getMyInfo(final Context context, final XtApiInterface.OnInfoEvents onEvents) {
        ...
        requestRepository.getMyInfo(new SilenceSubscriber<MyInfoBean>() {
            ...
            public void onNext(MyInfoBean response) {
                ...
                Logger.t(TAG).d("获取个人信息：sipId=" + sipId + ",sipPassword=" + sipPassword);
                LinphoneUtils.login(sipId, sipPassword, sipServer, sipServerPort);
        ...
        intent.putExtra(MQTTService.HOST, mqttServer);
        intent.putExtra(MQTTService.PORT, mqttServerPort);
...
//                            selfTopic, lowerCode);
        ...
        MQTTService.instance().getMessageLive().observeForever(new Observer<MqMessageBean>() {
            ...
            public void onChanged(MqMessageBean mqMessageBean) {
                ...
                onVideoEvents.elevatorStatusResult(mqMessageBean);
            }
        });
        ...
        requestRepository.getSipAndCode(elevEquipmentCode, new SilenceSubscriber<String>() {
            ...
            public void onNext(String response) {
                ...
                try {
                    JSONObject object = new JSONObject(response);
                    toCallSipId = object.optString("sip_id");
                    LinphoneUtils.callTo(toCallSipId, sipServer, false);
                } catch (JSONException e) {
                    e.printStackTrace();
                }
            }
