//package com.xt.library.jkplayer;
//
...
//     */
//    public KCstandardVideoPlayer(Context context, Boolean fullFlag) {
...
//    }
//
//    public KCstandardVideoPlayer(Context context, AttributeSet attrs) {
//        super(context, attrs);
//    }
//
//    @Override
...
//        super.init(context);
//        mBottomProgressBar = (ProgressBar) findViewById(com.xt.library.R.id.bottom_progressbar);
//        mTitleTextView = (TextView) findViewById(com.xt.library.R.id.title);
//        mThumbImageViewLayout = (RelativeLayout) findViewById(com.xt.library.R.id.thumb);
//        mLockScreen = (ImageView) findViewById(com.xt.library.R.id.lock_screen);
//
//        mLoadingProgressBar = findViewById(com.xt.library.R.id.loading);
//
...
//        return com.xt.library.R.layout.video_layout_standard;
//    }
//
//    @Override
...
////        int id = v.getId();
////        if (id == com.xt.library.R.id.surface_container) {
...
////                    break;
////            }
////        } else if (id == com.xt.library.R.id.progress) {
////            switch (event.getAction()) {
////                case MotionEvent.ACTION_DOWN:
////                    cancelDismissControlViewTimer();
////                    break;
...
////        super.onClick(v);
////        int i = v.getId();
////        if (i == com.xt.library.R.id.thumb) {
////            if (!mThumbPlay) {
////                return;
////            }
////            if (TextUtils.isEmpty(mUrl)) {
////                Toast.makeText(getContext(), getResources().getString(com.xt.library.R.string.no_url), Toast.LENGTH_SHORT).show();
////                return;
////            }
...
////                onClickUiToggle();
////            }
////        } else if (i == com.xt.library.R.id.surface_container) {
...
//            Toast.makeText(mContext, getResources().getString(com.xt.library.R.string.no_net), Toast.LENGTH_LONG).show();
//            return;
//        }
//        AlertDialog.Builder builder = new AlertDialog.Builder(getContext());
//        builder.setMessage(getResources().getString(com.xt.library.R.string.tips_not_wifi));
//        builder.setPositiveButton(getResources().getString(com.xt.library.R.string.tips_not_wifi_confirm), new DialogInterface.OnClickListener() {
//            @Override
...
//            }
//        });
//        builder.setNegativeButton(getResources().getString(com.xt.library.R.string.tips_not_wifi_cancel), new DialogInterface.OnClickListener() {
//            @Override
//            public void onClick(DialogInterface dialog, int which) {
//                dialog.dismiss();
//            }
...
//        Bitmap bitm = mTextureView.getBitmap(mTextureView.getSizeW(), mTextureView.getSizeH());
//        return bitm;
//    }
//
...
//            View localView = LayoutInflater.from(getContext()).inflate(com.xt.library.R.layout.video_progress_dialog, null);
//            mDialogProgressBar = ((ProgressBar) localView.findViewById(com.xt.library.R.id.duration_progressbar));
//            if (mDialogProgressBarDrawable != null) {
//                mDialogProgressBar.setProgressDrawable(mDialogProgressBarDrawable);
//            }
//            mDialogSeekTime = ((TextView) localView.findViewById(com.xt.library.R.id.tv_current));
//            mDialogTotalTime = ((TextView) localView.findViewById(com.xt.library.R.id.tv_duration));
//            mDialogIcon = ((ImageView) localView.findViewById(com.xt.library.R.id.duration_image_tip));
//            mProgressDialog = new Dialog(getContext(), com.xt.library.R.style.video_style_dialog_progress);
...
//        if (deltaX > 0) {
//            mDialogIcon.setBackgroundResource(com.xt.library.R.drawable.video_forward_icon);
//        } else {
//            mDialogIcon.setBackgroundResource(com.xt.library.R.drawable.video_backward_icon);
//        }
//
//    }
//
...
//            View localView = LayoutInflater.from(getContext()).inflate(com.xt.library.R.layout.video_volume_dialog, null);
//            mDialogVolumeProgressBar = ((ProgressBar) localView.findViewById(com.xt.library.R.id.volume_progressbar));
//            if (mVolumeProgressDrawable != null) {
//                mDialogVolumeProgressBar.setProgressDrawable(mVolumeProgressDrawable);
//            }
//            mVolumeDialog = new Dialog(getContext(), com.xt.library.R.style.video_style_dialog_progress);
...
//            View localView = LayoutInflater.from(getContext()).inflate(com.xt.library.R.layout.video_brightness, null);
//            mBrightnessDialogTv = (TextView) localView.findViewById(com.xt.library.R.id.app_video_brightness);
//            mBrightnessDialog = new Dialog(getContext(), com.xt.library.R.style.video_style_dialog_progress);
...
//            KCstandardVideoPlayer gsyVideoPlayer = (KCstandardVideoPlayer) gsyBaseVideoPlayer;
...
//        if (mLockCurScreen) {
//            mLockScreen.setImageResource(com.xt.library.R.drawable.unlock);
//            mLockCurScreen = false;
//            if (mOrientationUtils != null)
//                mOrientationUtils.setEnable(mRotateViewAuto);
//        } else {
//            mLockScreen.setImageResource(com.xt.library.R.drawable.lock);
//            mLockCurScreen = true;
//            if (mOrientationUtils != null)
...
//     * 全屏的UI逻辑
//     */
//    private void initFullUI(KCstandardVideoPlayer standardGSYVideoPlayer) {
//
//        if (mBottomProgressDrawable != null) {
...
//        //设置控制栏消失时间
//        mDismissControlViewTimer.schedule(mDismissControlViewTimerTask, 0);
//    }
//
